...
describe('config/task-config', function () {
    ...
    describe('setMakePlatform', function () {
        var makePlatform;
        var projectPath = path.join(process.cwd(), './test/fixtures/sample-project');
    ...
    describe('buildTarget', function () {
        var makePlatform;
        var makePlatromMode = 'test';
        var projectPath = path.join(process.cwd(), './test/fixtures/sample-project');
        var target = 'test_target';

        beforeEach(function () {
            makePlatform = new MakePlatform();
            makePlatform.init(projectPath, makePlatromMode);
            taskConfig.setMakePlatform(makePlatform);
        });
